...
// PcwKey enum, matrix-entry types, and the PROGMEM keyboard/joystick matrix
// tables live here to keep this sketch focused on logic. Included at global
// scope (before the anonymous namespace below) so its symbols are visible
// throughout.
#include "pcw_keymatrix.h"
